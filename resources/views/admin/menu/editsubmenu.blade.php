...
@section('title', 'Edit Sub Menu - Admin Anti Korupsi Indonesia')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Sub Menu</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row mt-3">
          <div class="col-md-4">
            <form method="POST" action="/admin/submenu/{{ $submenus->id }}">
              @csrf
              @method('patch')
              <input type="hidden" name="menu_id" value="{{ $menu->id }}">
              <div class="form-group mb-3">
                <label for="name">Menu</label>
                <input type="text" name="name" class="form-control" placeholder="Your Menu Name... "  value="{{ $submenus->name }}" required>
              </div>
              <div class="form-group mb-3">
                <label for="name">URL</label>
                <input type="text" name="url" class="form-control" placeholder="Your Menu URL... "  value="{{ $submenus->url }}" required>
              </div>
          ...
          <div class="col-md-6 col-10">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  <td><a href="{{ route('admin.submenu.edit', $result->id) }}" class="btn btn-outline-success">{{ $result->name }}</a></td>
                  <td>{{ $result->url }}</td>
                  <td>
