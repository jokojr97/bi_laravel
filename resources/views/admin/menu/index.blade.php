...
@section('title', 'Menu - Admin Anti Korupsi Indonesia')
            ...
            <table class="table table-striped"> 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $hasil->url }}</td>
                  <td>
                    @foreach($hasil->submenus as $result)
                      <a href="{{ route('admin.submenu.edit', $result->id) }}" class="btn btn-outline-success mb-1" target="_blank">{{ $result->name }}</a>
                    @endforeach
                  </td>
