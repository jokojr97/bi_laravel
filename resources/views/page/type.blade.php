...
@section('title') {{ $ids }} - Bojonegoro Institute @endsection
...
<section id="breadcrumbs" class="breadcrumbs" style="padding-top: 0;padding-bottom: 0">
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center pb-3">
      <h5 style="margin-bottom: 0px" class="text-capitalize">{{ $ids }} </h5>
      <ol>
        ...
        <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
          <div class="bg-danger">
            <div class="text-danger text-center bg-blues" style="border:8px solid orange">
              <h2 style="padding: 10px;color: white" class="text-capitalize">{{ $ids }}</h2>
            </div>
          </div>
          @if($ada==true)
                ...
                <div class="portfolio-wrap">
                  <div class="portfolio" style="background-color: #1f3983">
                    <div class="portfolio-wrap">
                      ...
                      <a href="/post/{{ $result->slug}}"><img src="/uploads/posts/{{ $result->feature_image}}" class="pl-2 pt-2 img-fluid img-news" alt="..."></a>
                      @else
                      <a href="/post/{{ $result->slug}}"><img src="/uploads/posts/AC_portfolio_1440x480.jpg" class="pl-2 pt-2 img-fluid img-news" alt="..."></a>
                      @endif
                    </div>
                  </div>
                </div>
